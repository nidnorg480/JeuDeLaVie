function FctIni(n) { // appelÃ©e par index.html
    switch (n) { // Initialisation de plusieurs figures connues
        case 0:
            TIT = "Vide"; X = 50; Y = 48; // dimensions de la grille (recommandÃ©: 16 Ã  500)
            D = 8; // dimension de la cellule en pixels (recommandÃ©: 1 Ã  20)
        ...
        case 8:
            ...
            return;
        case 9:
            TIT = "AlÃ©atoire"; X = 91; Y = 91; D = 8; CLR0 = '#000000'; CLR1 = '#FF77FF'; Clear();
